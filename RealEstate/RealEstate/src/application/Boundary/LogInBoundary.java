...
//		LogInController loginController = new LogInController();
		...
		if(result.equals("Success")&& profile.equals("Admin") ) {
		...
		}else if(result.equals("Success")&& profile.equals("Seller")) {
			AccountPass.userName = username.getText().toString();
			AccountPass.profile = profile;
			wrongLogin.setText("Success");
			m.changeScene("afterLoginSeller.fxml");
		}else if(result.equals("Success")&& profile.equals("Agent")) {
			AccountPass.userName = username.getText().toString();
			AccountPass.profile = profile;
			wrongLogin.setText("Success");
			...
			reviewAlert.setTitle("ERROR!");
			reviewAlert.setContentText("You did not select a login profile!");
			reviewAlert.setHeaderText("No profile selected!!");
